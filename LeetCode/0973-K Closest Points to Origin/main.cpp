...
public:
    ...
    */
    ...
    max heap has the biggest element at the root. Each time we add a point to the heap, if the size exceeds k,
    we pop our the root element. Finally, there are k smallest element in the pq
